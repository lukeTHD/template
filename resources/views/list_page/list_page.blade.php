            ...
            <table class="datatable-table" style="display: block;">
                <tbody class="datatable-body" style="">
                    ...
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        ...
                        <td data-field="Actions" data-autohide-disabled="false" aria-label="null" style="text-align: right;"
                            class="datatable-cell"><span style="overflow: visible; position: relative;">
                                <a href="{{ route('page.showPage',['id'=> $page['id']]) }}"
