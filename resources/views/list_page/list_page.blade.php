                    ...
                    <tbody class="datatable-body" style="">
                        @foreach($list_page as $key => $page)
                            <tr data-row="0" class="datatable-row" style="left: 0px;">
                                <td class="datatable-cell-sorted datatable-cell" data-field="OrderID" aria-label="0004-0800">
                                ...
                                <td data-field="ShipDate" aria-label="3/3/2017" class="datatable-cell">
                                    <span style="width: 150px;">
                                        <div class="font-weight-bolder text-primary mb-0">{{ $page->updated_at }}</div>
                                ...
                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell"><span style="overflow: visible; position: relative; width: 130px;">
                                    <div class="dropdown dropdown-inline">
                                        <a href="{{ route('page.showPage', ['id' => $page['id']] ) }}" title="Page details" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" data-toggle="dropdown"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-icon">
