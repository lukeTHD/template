...
<head>
    <base href="../../../">
    <meta charset="utf-8" />
    <title>Đăng nhập | Template Website</title>
            ...
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                        @if (\Session::has('errorMessage707'))
                        @foreach(\Session::get('errorMessage707') as $err)
                        ...
                        <div class="alert alert-solid-success alert-bold fade show kt-margin-t-20 kt-margin-b-40"
                            role="alert">
                            <div class="alert-icon"><i class="fa fa-check"></i></div>
                            <div class="alert-text">{{__('label.'.\Session::get('successMessage'))}}</div>
                            <div class="alert-close">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"><i class="la la-close"></i></span>
                                </button>
                        ...
                        <div class="alert alert-solid-danger alert-bold fade show kt-margin-t-20 kt-margin-b-40"
                            role="alert">
                            <div class="alert-icon"><i class="fa fa-exclamation-triangle"></i></div>
                            <div class="alert-text">{{__('error.error'.\Session::get('errorMessage'))}}</div>
                            <div class="alert-close">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true"><i class="la la-close"></i></span>
                                </button>
                        ...
                        @endif
                        <form class="form" novalidate="novalidate" id="kt_login_signin_form" method="post" action="{{route('user.post.login')}}">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                ...
                                <span class="text-muted font-weight-bold font-size-h4">New Here?
                                    <a href="javascript:;" id="kt_login_signup"
                                        class="text-primary font-weight-bolder">{{__('label.login.create_an_account')}}</a></span>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">{{__('label.login.username')}}</label>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mt-n5">
                                    <label class="font-size-h6 font-weight-bolder text-dark pt-5">{{__('label.login.password')}}</label>
                                    <a href="javascript:;"
                                        class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5"
                                        id="kt_login_forgot">{{__('label.login.forgot_password')}} ?</a>
                                </div>
                            ...
                            <div class="pb-lg-0 pb-5">
                                <button type="button" id="kt_login_signin_submit"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">{{__('label.login.sign_in')}}</button>
                                <button type="button"
