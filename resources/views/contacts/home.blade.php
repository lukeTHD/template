                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-7">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-xl-4 mt-6  mt-lg-0 ">
                            ...
                            <tbody>
                                ...
                                <tr  v-for="item in list_subject" @click="redirectToPrivate(item.id)" style="cursor: pointer" data-row="0" class="datatable-row" style="left: 0px;border-bottom: 1px solid #EBEDF3;" >
                                    ...
                                    <td style="vertical-align: middle;" data-field="ShipDate" aria-label="1/29/2017" class="datatable-cell">
                                        <span style="width: 126px;">${item.create_at}</span>
                                    </td>
                                </tr>
                                <!-- end: v-for -->
                            </tbody>
...
@section('scripts')
    ...
    <script>
        new Vue({
            ...
            methods:{
                getData(){
                    axios.get('http://localhost:81/template/public/api/getSubject')
                    .then(
                        response=>{
                ...
                redirectToPrivate(val){
                    window.location.href = "http://localhost:81/template/public/private?id="+val;
                },
                getDataByFill(){
                    axios.post('http://localhost:81/template/public/api/fillData',{
