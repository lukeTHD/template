                                ...
                                <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                                    ...
                                    <div class="navi-item my-2">
                                        <a href="#" class="navi-link active">
                                            ...
                                            <span class="label label-rounded label-light-success font-weight-bolder">${sumFromIdNotSeen}</span>
                                            </span>
                                        </a>
                                    </div>
                                    <!--end::Item-->
                                ...
                                <div class="list list-hover min-w-500px" data-inbox="list">
                                    ...
                                    <div class="d-flex align-items-start list-item card-spacer-x py-3" >
                                        ...
                                        <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                                            <div>
                                                <span class="text-muted1 font-weight-bolder ">Thank you for ordering UFC 240 Holloway vs Edgar Alternate camera angles...</span>
                                            </div>
                                        </div>
                                        <!--end::Info-->
                                        <!--begin::Datetime-->
...
@section('scripts')
    ...
    <script>
        new Vue({
            ...
            el:"#app",
            data:{
                sumFromIdNotSeen:null,
            },
            created: function(){
                axios.get('http://localhost:81/template/public/api/getSumID')
                .then(
                    response=>{this.sumFromIdNotSeen=response.data;
                })
                .then(function(){
                    scrollBottomChat();
                });
