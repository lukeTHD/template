...
<div id="app">
    <div class="flex-row-fluid ml-lg-8 d-block" id="kt_inbox_view">
                                ...
                                <div class="box-messenger__header">
                                    <div class="symbol symbol-50 pl-4 " >
                                        <div class="d-flex align-items-center ">
                                            ...
                                            <div class="ml-4  ">
                                                <p class="font-size-lg font-weight-bolder text-dark-75 text-hover-primary">${item.name}</p>
                                                <span class="font-weight-bold text-muted cursor-pointer " data-toggle="dropdown">${item.email}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="font-weight-bold text-muted pr-4 ">${item.create_at_format}</div>
                                </div>
                                <div  class="px-4 py-4">
        ...
        <!--end::Card-->
        <div class="border-0 ql-container ql-snow px-4">
    ...
    <script>
        ...
        new Vue({
            ...
            created: function(){
                ...
                axios.get('http://localhost:81/template/public/api/getTitle/'+this.id_subject)
                .then(
                    response=>{this.title=response.data[0].contentTitle;
            ...
            watch:{
                    status:function(val){
                        axios
                        .put("http://localhost:81/template/public/api/getSubject/" + this.id_subject, {
                            status: val,
                        })
                        .then((req) => {
            ...
            methods:{
                ...
                getListContact:function(){
                    axios.get('http://localhost:81/template/public/api/getContentsByIdTitle/'+this.id_subject)
                    .then(
                        response=>{
