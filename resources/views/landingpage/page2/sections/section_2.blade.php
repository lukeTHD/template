            ...
            <div class="col-lg-6 pr-0 h-100 hide-sm">
                <div class="">
                    <div class="sign-left-box">
                        <h2 class="text-center edit-text" data-number-text="147" data-content="CRM" data-type="text">CRM
                        </h2>
                        ...
                        <ul class="list-unstyled mt-5">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="text-white edit-text" data-number-text="150" data-content="Service Cloud"
                                        data-type="text">Service Cloud</h4>
                            ...
                            <li class="media my-4">
                                <img class="mr-3 edit-image" data-number-text="152" data-content="{{ asset('landingpage/page2/images/icn6.svg')}}"
                                    ...
                                    src="{{ asset('landingpage/page2/images/icn6.svg')}}" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h4 class="text-white edit-text" data-number-text="153" data-content="Sales Cloud"
                                        data-type="text">Sales Cloud</h4>
                                    <p class="text-white edit-text" data-number-text="154"
                                        data-content="Support every customer.<br> Anytime. Anywhere." data-type="text">
                                        Support every customer.<br> Anytime. Anywhere.</p>
                                </div>
                            </li>
                            <li class="media">
                                <img class="mr-3 edit-image" data-number-text="155" data-content="{{ asset('landingpage/page2/images/icn6.svg')}}"
                                    ...
                                    src="{{ asset('landingpage/page2/images/icn6.svg')}}" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h4 class="text-white edit-text" data-number-text="156" data-content="Marketing Cloud"
                                        data-type="text">Marketing Cloud</h4>
                        ...
                        <div class="close-modal cs-fade-in-up" data-dismiss="modal" aria-label="Close">
                            <svg class="arrow-icon-svg" width="23" height="16" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <form>
                        ...
                        <div class="form-group ">
                            <div class="input-group mb-3  uiIcon">
                                ...
                                <svg class="svgIcon fill-smoke--d" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    viewBox="0 0 30 30">
                                    <path
