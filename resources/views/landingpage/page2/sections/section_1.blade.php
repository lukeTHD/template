                ...
                <nav class="navbar navbar-light navbar-expand-lg mainmenu">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item"> <a class="nav-link edit-text btn-href" data-number-text="2" data-content="Features" data-type="button">Features</a> </li>
                            <li class="nav-item"> <a class="nav-link edit-text btn-href" data-number-text="3" data-content="Pricing" data-type="button">Pricing </a> </li>
                            <li class="nav-item"> <a class="nav-link edit-text btn-href" data-number-text="4" data-content="Webinars" data-type="button">Webinars</a> </li>
                            <li class="nav-item"> <a class="nav-link edit-text btn-href" data-number-text="5" data-content="Blog" data-type="button">Blog</a> </li>
