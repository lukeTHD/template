...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="80">
				...
				<div class="row">
					<div class="col-md-3">
						<div class="navbar-header">
							...
							<a href="index.html" class="navbar-brand"><img src="{{ asset('landingpage/page4/assets/img/logo.png')}}" alt="logo"></a>
						</div>
					</div>
					<div class="col-md-9">
						<div class="navbar-collapse collapse">
							<nav>
								<ul class="nav navbar-nav navbar-right">
									...
									<li><a class="block-menu" href="#">Get a quote</a></li>
								</ul>
							</nav>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
				  <div class="col-lg-6 col-sm-12 col-xs-12">
					<div class="hero-text">
						 <h1>Easy Way to Trade your Bitcoin</h1>
						 <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec elementum mauris. Praesent vehicula gravida dolor, ac efficitur sem.</p>
						<div class="home_btn">
							<a  class="get_all_btn" href="contact.html">Get started</a>
						</div>
					</div>
				  </div><!--- END COL -->
					<div class="col-lg-6 col-sm-12 col-xs-12">
						<div class="hero-text-img">
							<img class="img-responsive" src="{{ asset('landingpage/page4/assets/img/desktop.png')}}" alt="">
						</div>
				  </div><!--- END COL -->
				</div><!--- END ROW -->
			</div><!--- END CONTAINER -->
				...
				<div class="row">
					<div class="col-xs-12 col-md-6" data-aos="fade-right">
						<div class="single_about_two">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.Lorem ipsum dolor sit amet. </p>
						</div>
						<div class="our_video">
							<a class="video-play get_all_btn" href="https://player.vimeo.com/video/116147791">watch video</a>
						</div>
					</div><!-- END COL-->
					<div class="col-md-5 col-md-offset-1 col-xs-12">
						<div class="single_about_two_img">
							<img class="img-responsive" src="{{ asset('landingpage/page4/assets/img/graph-dark-a.png')}}" alt="">
						</div>
					</div><!-- END COL-->
				</div><!-- END ROW-->
			</div><!-- END CONTAINER-->
		...
		<!-- START FEATURED -->
		<section id="features" class="template_feature">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
				...
				<div class="row text-center">
					<div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up">
						<div class="featurebox">
							<div class="feature-icon">
								<i class="fa fa-heart"></i><span class="number">1</span>
							</div>
							<h3>Safe and Secure</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium beatae consectetur ea eaque facilis hic, impedit ipsa laudantium modi nostrum.</p>
						</div>
					</div><!-- END COL-->
					<div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up">
						<div class="featurebox">
							<div class="feature-icon">
								<i class="fa fa-paper-plane-o"></i><span class="number">2</span>
							</div>
							<h3>Mobile App</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium beatae consectetur ea eaque facilis hic, impedit ipsa laudantium modi nostrum.</p>
						</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up">
						<div class="featurebox">
							<div class="feature-icon">
								<i class="fa fa-trophy"></i><span class="number">3</span>
							</div>
							<h3>Secure Wallet</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium beatae consectetur ea eaque facilis hic, impedit ipsa laudantium modi nostrum.</p>
						</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up">
						<div class="featurebox">
							<div class="feature-icon">
								<i class="fa fa-money"></i><span class="number">4</span>
							</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up">
						<div class="featurebox">
							<div class="feature-icon">
								<i class="fa fa-database"></i><span class="number">6</span>
							</div>
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1 col-xs-12">
						<div class="single_about_details_img">
							<img class="img-responsive" src="{{ asset('landingpage/page4/assets/img/desktop2.png')}}" alt="">
						</div>
					</div><!-- END COL-->
				</div><!-- END ROW-->
			</div><!-- END CONTAINER-->
		...
		<!-- START HOW TO BUY -->
		<section class="howtobuy_feature section-padding">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="section-title text-center">
				...
				<div class="row text-center">
					<div class="col-xs-12 col-sm-4" data-aos="fade-up">
						<div class="howtobuy">
							...
							<h3>Sign up for BuyCoin</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium beatae consectetur ea eaque facilis hic impedit.</p>
						</div>
					</div><!-- END COL-->
					<div class="col-xs-12 col-sm-4" data-aos="fade-up">
						<div class="howtobuy">
		...
		<div class="request_area">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="section-title text-center">
							<h1 class="section-title-white">Request A Call Back</h1>
							<span></span>
							<p class="section-title-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolorem dicta libero veritatis reiciendis quis pariatur magni.</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-12 col-md-4">
						<div class="request_call_back_img">
							<img src="{{ asset('landingpage/page4/assets/img/request.png')}}" class="img-responsive" alt="" />
						</div>
					</div>
							...
							<form method="post" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="form-group col-md-12">
										...
										<textarea rows="6" name="message" class="form-control" placeholder="Special Message" required="required"></textarea>
									</div><!-- END COL -->
									<div class="col-md-12">
										<div class="actions">
		...
		<!-- START BITCOIN PRICE -->
		<div class="bitcoin_price section-padding">
			<div class="container">
				<div class="row text-center">
					<div class="col-md-12">
						<div class="tab" role="tabpanel">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#Section1" role="tab" data-toggle="tab">USD</a></li>
								<li role="presentation"><a href="#Section2" role="tab" data-toggle="tab">EUR</a></li>
								<li role="presentation"><a href="#Section3" role="tab" data-toggle="tab">GBP</a></li>
								<li role="presentation"><a href="#Section4" role="tab" data-toggle="tab">RUB</a></li>
							</ul>
							<div class="tab-content tabs">
								<div role="tabpanel" class="tab-pane fade in active" id="Section1">
								   <ul class="bitcoin_offers">
										<li class="bitcoin_offers__item">
											<span>Get 0.0062 BTC</span>
											<span>for</span>
											<span class="price">$100</span>
											<a class="bitcoin_button get_all_btn" href="#">Buy Now</a>
										</li>
										<li class="bitcoin_offers__item">
											<span>Get 0.0062 BTC</span>
											<span>for</span>
								...
								<div role="tabpanel" class="tab-pane fade" id="Section2">
									<ul class="bitcoin_offers">
										<li class="bitcoin_offers__item">
											<span>Get 0.0012 BTC</span>
											<span>for</span>
											<span class="price">€100</span>
											<a class="bitcoin_button get_all_btn" href="#">Buy Now</a>
										</li>
										<li class="bitcoin_offers__item">
											<span>Get 0.0022 BTC</span>
											<span>for</span>
											<span class="price">€200</span>
											<a class="bitcoin_button get_all_btn" href="#">Buy Now</a>
										</li>
										<li class="bitcoin_offers__item">
											<span>Get 0.0032 BTC</span>
											<span>for</span>
											<span class="price">€300</span>
											<a class="bitcoin_button get_all_btn" href="#">Buy Now</a>
										</li>
										<li class="bitcoin_offers__item">
											<span>Get 0.0042 BTC</span>
											<span>for</span>
											<span class="price">€400</span>
											<a class="bitcoin_button get_all_btn" href="#">Buy Now</a>
										</li>
		...
		<!-- START TICKET  -->
		<div class="ticket-logo section-padding">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="section-title text-center">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 col-sm-12 col-xs-12">
						<div class="content">
							<a href="https://bitcoincharts.com/charts/bitstampUSD#rg60ztgSzm1g10zm2g25zv"></a>
						</div>
					</div><!-- END COL-->
					<div class="col-md-5 col-sm-12 col-xs-12">
                        <div class="currency_content">
                            ...
                            <p>Lorem Idivsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.</p>
                            <script src="https://www.cryptonator.com/ui/js/widget/calc_widget.js"></script>
                            <a href="#" class="get_all_btn">Buy Now!</a>
                        </div>
					</div><!-- END COL-->
				</div><!-- END ROW-->
			</div><!-- END CONTAINER-->
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-4">
						<div class="work_action_btn">
							<a class="get_all_btn" href="#">Discover More</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row text-center">
					<div class="col-xs-12" data-aos="fade-up">
						<div id="testimonial-slider" class="owl-carousel">
							<div class="our-team">
								<div class="pic">
									<img src="{{ asset('landingpage/page4/assets/img/team/team-1.jpg')}}" alt="">
									<ul class="social">
								...
								<div class="team-content">
									...
									<small class="post">Founder and Ceo</small>
							...
							<div class="our-team">
								<div class="pic">
									<img src="{{ asset('landingpage/page4/assets/img/team/team-2.jpg')}}" alt="">
									<ul class="social">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
								...
								<div class="team-content">
									<h3 class="title">Naika Pornima</h3>
									<small class="post">Founder and Ceo</small>
									<small>Email: <b>mail@example.com</b></small>
								</div>
								<div class="team-layer">
							...
							<div class="our-team">
								<div class="pic">
									<img src="{{ asset('landingpage/page4/assets/img/team/team-3.jpg')}}" alt="">
									<ul class="social">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
							...
							<div class="our-team">
								<div class="pic">
									<img src="{{ asset('landingpage/page4/assets/img/team/team-4.jpg')}}" alt="">
									<ul class="social">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
				...
				<div class="row">
					<div class="col-lg-4 col-sm-4 col-xs-12">
						<div class="post-slide">
							<div class="post-img">
								<img src="{{ asset('landingpage/page4/assets/img/blog/1.jpg')}}" alt="">
								<div class="post-date">
							...
							<div class="post-content">
								<h3 class="post-title"><a href="blog.html">Latest News Post</a></h3>
								...
								<a href="blog.html" class="get_all_btn">read more</a>
							</div>
						</div>
					</div><!--- END COL -->
					<div class="col-lg-4 col-sm-4 col-xs-12">
						<div class="post-slide">
							<div class="post-img">
								<img src="{{ asset('landingpage/page4/assets/img/blog/2.jpg')}}" alt="">
								<div class="post-date">
									<span class="date">30</span>
									<span class="month">June</span>
								</div>
					...
					<div class="col-lg-4 col-sm-4 col-xs-12">
						<div class="post-slide">
							<div class="post-img">
								<img src="{{ asset('landingpage/page4/assets/img/blog/3.jpg')}}" alt="">
								<div class="post-date">
									<span class="date">30</span>
									<span class="month">June</span>
								</div>
		...
		<!-- START FOOTER TOP -->
		<section class="footer_top section-padding">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="single_footer">
							<img src="{{ asset('landingpage/page4/assets/img/logo.png')}}" alt="" />
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nec elementum mauris. Praesent vehicula gravida dolor.</p>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="single_footer">
							...
							<div class="footer_blog">
								<h5><a href="blog.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a></h5>
								<div class="meta_tag">
									<a href="#">By James Bond</a>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="single_footer">
							<h4>subscribe us</h4>
							<span class="f_line"></span>
							<p>Lorem ipsum dolor sit amet, consect ascing elit, sed do eiusmod</p>
							<form novalidate="" target="_blank" class="validate" name="mc-embedded-subscribe-form" method="post" action="http://site90.us11.list-manage.com/subscribe/post?u=599a2153f4b86cb2f92d4af3a&amp;id=26d7c26287">
								...
								<span><button class="btn btn-default get_all_btn" name="subscribe" type="submit">Subscribe</button></span>
