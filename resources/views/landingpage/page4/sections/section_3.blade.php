<!-- START ABOUT -->
<section class="about-two section-padding section-page" data-section-index="3">
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-6" data-aos="fade-right">
                ...
                <div class="our_video">
                    <a class="video-play get_all_btn edit-text btn-href" data-number-text="19"
                        data-content="https://player.vimeo.com/video/116147791" data-type="button"
                        href="https://player.vimeo.com/video/116147791">watch video</a>
                </div>
            </div><!-- END COL-->
            <div class="col-md-5 col-md-offset-1 col-xs-12">
                <div class="single_about_two_img">
                    <img class="img-responsive edit-image" data-number-text="20"
                        data-content="{{ asset('landingpage/page4/assets/img/graph-dark-a.png')}}" data-type="image"
                        data-height="443" data-width="457" src="{{ asset('landingpage/page4/assets/img/graph-dark-a.png')}}"
                        alt="">
                </div>
            </div><!-- END COL-->
        </div><!-- END ROW-->
