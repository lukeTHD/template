...
@endsection
@section("content")
    <main class="page-term-use">
        <section class="term-use block-general">
            <div class="container">
                <div class="block-general__inner">
                    <h2 class="title">
                        Term of use
                    </h2>
                    <div class="des">
                        <p>If you have a website and you’d like to help promote Lotto Go, contact us to become an affiliate.</p>
                        <p>As a Lotto Go partner, you'll be entitled to the following benefits:</p>
                    </div>
                    <div class="content">
                        ...
                        as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on
                        ...
                        is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a line in section 1.10.32.
